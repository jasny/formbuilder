...
abstract class FormGenerator
{
     ...
     * @var string
     */
    public static $parentClass = 'Jasny\FormBuilder\Form';
...
PHP;
     ...
     * @return string
     */
    protected static function getDriver($source)
    {
    ...
    protected static function autoload($class)
    {
        ...
        $name = static::classToName($classname);
        if (!empty($name)) $info = static::getInfo($name);
        
        if (empty($info)) return; // Class doesn't match any table
        if (self::loadFromCache($class, static::getChecksum($info))) return;
    ...
    /**
     * Get the source name from the classname
     * 
     * @param string $classname
     * @return strint
     */
    abstract protected static function classToName($classname);
     ...
     * @return array
     */
    abstract protected static function getInfo($table);
